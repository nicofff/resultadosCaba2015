...
print "mesa registrados votaron pro eco blanco impugnado nulo recurrido tecnico"
for mesa in mesas:
	...
	if mesa.get_cargada():
		...
		print "%s %s %s %s %s %s %s %s %s %s" % (mesa.get_numero(),votantes,votaron,pro,eco,blanco,imp,nul,rec,tec)
